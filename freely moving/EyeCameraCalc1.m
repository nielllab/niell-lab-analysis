...
function [newtheta,newphi,EllipseParams,ExtraParams] = EyeCameraCalc1(Vid1,Pointsx,Pointsy)
...
EllipseParams = zeros(size(Vid1,3),7);
ExtraParams = zeros(size(Vid1,3),6);

parfor v=1:size(Vid1,3)
...
figure; imagesc(Vid1(:,:,i)); colormap gray; axis equal off; hold on;
