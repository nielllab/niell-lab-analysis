...
files={'J462aAnalyzed_All_090319_1.mat','J462cAnalyzed_All_090319_1.mat',...
    'J463bAnalyzed_All_090319_1.mat','J463cAnalyzed_All_090319_1.mat','J465dAnalyzed_All_090319_1.mat',...
    'J470bAnalyzed_All_090319_1.mat','J475cAnalyzed_All_090319_1.mat'}; %'J462bAnalyzed_All_090319_1.mat', 'J463dAnalyzed_All_090319_1.mat',
...
scaleR=[]; Lgood=[];ccL=[];slopeL=[];scaleL=[]; ani=[]; sess=[]; date=[];clipnum=[];
n=0;
...
%         'dthetaR','dthetaL','dphiR','dphiL','dXRcent';
    ...
    load(fname,'cricket_xy','mouse_xy','cricketV','theta', 'dTheta','azT','mouseV','goodTheta','range','theta','dTheta','appEpoch','useData','EllipseParamsR',...
...
if savePDF
    ...
    filen=sprintf('%s','Analyzed_090319_AllAnimals_1','.pdf')
...
afilename=sprintf('%s','Analyzed_AllAnimals_090319_New','.mat')
