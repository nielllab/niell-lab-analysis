...
clear all
n_obs=0;
afile = {'C:\data\ephys matlab data\030912_LGN\recording2\analysis_final.mat',...
    'C:\data\ephys matlab data\030912_LGN\recording3\analysis3_final.mat',...
    'C:\data\ephys matlab data\030912_LGN\recording4\analysis_4final.mat',...
    'C:\data\ephys matlab data\031012_lgn\recording1REAL\analysis1REAL.mat',...
    'C:\data\ephys matlab data\031012_lgn\recording2\analysis_2final.mat',...
    'C:\data\ephys matlab data\031512_LGN\analysis_2final.mat',...
...
cell_list = zeros(length(obs_norm));
n=0;
for i = 1:max(T);
    members = find(T==i);
