...
for dataset = 1:2  %%% adult vs eye opening
    ...
    elseif dataset ==2
        afiles = {'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\4_29_13_EO1\mouseC\analysis_4_29_13_C.mat',...
            ...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\8_7_13_EO1\rec2_full_clustering\analysis_8_7_13_rec2.mat',...
            ...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\10_1_13_EO2\rec1\analysis_10_1_13_EO2_rec1.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_20_13_EO0\rec1\analysis_11_20_13_rec1.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_20_13_EO0\rec2\analysis_11_20_13_EO0_rec2.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_21_13_EO1_mouseA\analysis_11_21_13_mouseA_EO1.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_23_13_EO2\analysis_11_23_13_EO2.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_26_13_mouseA_EO1\rec1\analysis_11_26_13_EO1_mouseA_rec1.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_26_13_mouseA_EO1\rec2\analysis_11_26_13_EO1_rec2.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_26_13_mouseB_EO1\analysis_11_26_13_mouseB_EO1.mat',...
            'D:\Jen_ephys_data\developmental_periods\Good recordings\EO1_EO2\11_27_13_mouseB_EO2\analysis_11_27_13_EO2_mouseB.mat'}; %%% tg
    end
    ...
    for i = 1:length(afiles)
        ...
        if exist('wn','var')
            for i = 1:length(wn);
                if ~isempty(wn(i).N)
                    ev(i) = mean(wn(i).crf(9:12))-mean(wn(i).crf([1 2 19 20]));
                    sp(i) =mean(wn(i).crf([1 2 19 20]));
                else
                    ev(i)=NaN;
                    sp(i)=NaN;
                end
