...
N =0; cells=0;
for dataset = 1:1  %%% adult vs eye opening
...
figure
imagesc(squeeze(moveLFP_bar(LFPmax_Bar<0.5*10^4,1,:)))

figure
imagesc(squeeze(moveLFP_bar(LFPmax_Bar<0.5*10^4,2,:)))

ly = 6;
figure
imagesc(squeeze(moveLFP_bar(age'==1 & lyr <ly & LFPmax_Bar<0.5*10^4,1,:)))

figure
imagesc(squeeze(moveLFP_bar(age'==1 & lyr <ly & LFPmax_Bar<0.5*10^4,2,:)))
...
figure
imagesc(squeeze(moveLFP_bar(LFPmax_Bar<2*10^4,2,:)))
...
figure
for ly = 2:4
    plot(1:120,squeeze(nanmean(moveLFP_bar(age'==2 & lyr==ly & LFPmax_Bar<0.5*10^4,1,:),1)),'Linewidth',1+ly/3);
hold on
plot(1:120,squeeze(nanmean(moveLFP_bar(age'==2 & lyr==ly & LFPmax_Bar<0.5*10^4,2,:),1)),'g','Linewidth',1+ly/3);
end
title('mean adult')
...
figure
imagesc(squeeze(moveLFP_bar(LFPmax_Bar<0.7*10^4,1,:)))

figure
imagesc(squeeze(moveLFP_bar(LFPmax_Bar<1.5*10^4,2,:)))
