...
for rep=1:5;
   ...
   figure
    ...
    plot(mean(B0(usedSupra,rep)),mean(B1(usedSupra,rep)),'g+');hold on;
    plot(mean(B0(usedSupra,rep)),mean(B1(usedSupra,rep))+std(B1(usedSupra,rep)),'g+');hold on;
    plot(mean(B0(usedSupra,rep)),mean(B1(usedSupra,rep))-std(B1(usedSupra,rep)),'g+');hold on;
    plot(mean(B0(usedSupra,rep))+std(B0(usedSupra,rep)),mean(B1(usedSupra,rep)),'g+');hold on;
    plot(mean(B0(usedSupra,rep))-std(B0(usedSupra,rep)),mean(B1(usedSupra,rep)),'g+');hold on;
