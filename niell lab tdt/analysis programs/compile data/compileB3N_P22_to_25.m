%function compile_B3N_lgn_P22-25
close all
clear all
n_obs=0;
day = [1 1 1 2 3 3 ];

PostnatalAge = [30 30 15 15 15 15 15 15 15]
...
histfile = {'05072013_P16_sec2_sl2_recording_1_LGNsection3_electrode1to32.tif','05072013_P16_sec2_sl2_recording_1_LGNsection3_electrode33to64.tif';...
    '','';...
    '','';...
    '','';...
    '','';...
