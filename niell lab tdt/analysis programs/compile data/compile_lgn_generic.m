...
afile = {     'analysis_11282012_rec1b.mat'...
    'analysis_11282012_rec2.mat'...
    'analysis_11282012_rec3.mat'...
    'analysis_11292012_rec1.mat'...
    'analysis_11292012_rec3.mat'...
    'analysis_11302012_rec1.mat'...
    'analysis_11302012_rec2.mat'...
    'analysis_12062012_rec1.mat'...
    'analysis_12062012_rec2.mat'...
    'analysis_12072012_rec1.mat'...
    'analysis_12072012_rec2.mat'...
    'analysis_12072012_rec3.mat'...
    };
% 'analysis_12062012_rec3.mat'...

histoPath = 'C:\data\matlab data\Wayne Matlab data\histology\1128_to1207_for_matlab_analysis\'
histfile = { '11282012_penetration_1_recording_1_sec6sl1_Fig55.tif' ...
    '11282012_penetration_2_recording_2_sec1sl2_fig54.tif'...
    '11282012_penetration_3_recording_3_sec1sl2_fig54.tif'...
    ...
    '', ...
    '12062012_penetration_2_recording_1_sec7sl1_Fig48.tif'...
    '12062012_penetration_4_recording_2_sec1sl2_Fig46.tif'...
...
for i = 1:length(afile)
    ...
    if ~isempty(histfile{i})
        histfile{i} = [histoPath histfile{i}];
    end
end
...
PaxPos=[55 54 54 47 50 50 53 48 46 51];
lgnPos  = [5 3 3 2 3 4 2 1 4 5 1 2 3];
...
params.Fs = 0.25*1/median(diff(movement_all(cell_n).lfpT(1:1000)));
        ...
        params.tapers = [5 30  1];
        params.fpass = [0 90];
        [C ph s12 s1 s2 t fre] = cohgramcpt(movement_all(cell_n).lfpV(1:4:end)',movement_all(cell_n).spikes',[30 10],params);
