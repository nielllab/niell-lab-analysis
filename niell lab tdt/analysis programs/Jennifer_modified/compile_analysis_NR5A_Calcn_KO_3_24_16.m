...
apath = 'D:\' %'E:\Jennifer\Jennifer_analysis\'; 
...
for dataset = 1:2  %%% control ("wt") NR5A1-cre/CHR2 animals vs. NR2A deleted NR5A1-cre
    ...
    if dataset ==1
        afiles= { 'Jen_analysis\NR5A_Pinping\1_13_15_pos_ctl\analysis_2.mat',...
            'Jen_analysis\NR5A_Pinping\12_22_14_pos_ctl\analysis_2.mat',...
           'Jen_analysis\NR5A_Pinping\2_25_15\analysis_2.mat',...
           'Jen_analysis\NR5A_Pinping\3_11_15_wt\full\analysis_2.mat',...
          'Jen_analysis\NR5A_Pinping\4_9_15\Full\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\4_10_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\4_13_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\4_30_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\5_4_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\5_11_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\5_14_15\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\6_25_15\analysis_2',...
         'Jen_analysis\NR5A_Pinping\6_29_18\analysis_2A',...
         'Jen_analysis\NR5A_Pinping\8_10_15_new\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\8_17_15_rec2\analysis_2.mat',...
         'Jen_analysis\NR5A_Pinping\1_18_16\1_18_16_analysis_2.mat'};
...
%  %'NR5A_Pinping\3_7_15\analysis_2.mat',...
    elseif dataset==2
        afiles = {'johanna_analysis\1_12_16\analysis.mat',...
            'johanna_analysis\1_19_16\analysis.mat',...
            'johanna_analysis\1_14_16\analysis.mat',...
            'johanna_analysis\1_21_16\analysis.mat',...
            'johanna_analysis\1_26_16\analysis.mat',...
            'johanna_analysis\1_28_16\analysis.mat',...
            'johanna_analysis\2_2_16\analysis.mat',...
            'johanna_analysis\2_9_16\analysis.mat',...
            'johanna_analysis\3_4_16\analysis.mat'};
%'johanna_analysis\2_18_16\analysis.mat',...
%'johanna_analysis\2_23_16\analysis.mat',...
%      
    end
...
frac_responsive_CKO=(sum(pinped_resp_grat & CKO)/sum(pinped & CKO))
...
%     
        ...
        subplot(1,3,1);
        plot(wvform(use(i),:),col);axis off
        title(['OS ',num2str(OSI(use(i)))])
        
        subplot(1,3,2);
        if ~isempty(STA_peak{1,use((i))})
            colormap redblue
            imagesc(STA_peak{1,use((i))}',[-64 64]);
            title(['SF pref ',num2str(driftwpref(use(i)))])
        end
