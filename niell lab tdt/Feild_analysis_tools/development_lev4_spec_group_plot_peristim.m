         ...
         for iLayer = 1:3
            ...
            for iLatency= 1:2
                ...
                try                                            
                    ...
                    xlim(log10([4 160]))
                    ylim([0 2])
                    H = title(sprintf('%s %s %s',  layers{iLayer}, G_stat.state{iState}, sum(sl)));
                    set(H,'FontSize', 6);
             ...
             for iLayer = 1:3
                ...
                for iLatency= [2 1]
                    ...
                    try                                            
                        ...
                        nt = {'pyr', 'int'};
                        xlim(log10([4 160]))
                        H = title(sprintf('%s %s %s %s',  layers{iLayer}, G_stat.state{iState}, stage{iType}, sum(sl)));
                        set(H,'FontSize', 6);
                    end         
                end
            end
             ...
             for iLayer = 1:3
                ...
                for iState= [2 1]
                    ...
                    try                                            
                        ...
                        nt = {'pyr', 'int'};
                        xlim(log10([4 160]))
                        H = title(sprintf('%s %s %s %s',  layers{iLayer}, latencies{iLatency}, stims{iStim}, stage{iType+1}, sum(sl)));
                        set(H,'FontSize', 6);
                    end         
                end
            end
