...
%'4_30_15_analysis_2.mat',...
    ...
    '3_26_15_analysis_2.mat',...%% 3 cells, 49-10
    '4_23_15_analysis_2.mat',...%17-5, 57-8
    '6_18_15_analysis_2A.mat',...%53-7,
    '6_22_15_analysis_2A.mat',...%41-11,17-11
...
%  '3_26_15_analysis_2.mat',...
 %   '2_2_15_analysis_2.mat',...
   ...
   'analysis_1_20_16.mat'}%
       %'8_6_15_analysis_2.mat' & 8_7_15_analysis,.. sessions corrupted '8_18_15_analysis_2.mat',...%can't find cluster file
    end
...
%         for blocknum = 3:4
            ...
            %flags = struct('visStim',1,'lfpTseries',1,'lfpSpectra',1,'mouseOn',1,'laserOn',1);
...
%             
                ...
                if isempty(matchCell)
                    ...
                    unitdata{cell_n+n}.waveform=wave(cell_n,:);
                    unitdata{cell_n+n}.T2P=trough2peak(cell_n);
                    unitdata{cell_n+n}.Trough_dep=trough_depth(cell_n);
                    unitdata{cell_n+n}.Trough_wid=trough_width(cell_n);
...
save('JLH_NMDA_8_11_17_extract_drift_waveform','exptdata','unitdata','-v7.3');