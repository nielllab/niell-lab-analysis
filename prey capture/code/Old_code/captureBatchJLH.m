...
pathname='C:\Users\nlab\Desktop\Prey Capture track Data Eyre\Prey_tracks\'; %eyre path
if ismac
...
files(n).sex=1;
files(n).FrameS=1;
files(n).FrameEnd=1710;
files(n).FrameFlash=''
files(n).Moviefile='Prey1\7_28_15\Prey1_sub1_trial2_NIR.avi'
...
files(n).sex=1;
files(n).FrameS=1;
files(n).FrameEnd=863;
files(n).FrameFlash=''
files(n).Moviefile='Prey1\7_28_15\Prey1_sub1_trial3_full_spec.avi'
...
files(n).sex=1;
files(n).FrameS=1;
files(n).FrameEnd=5400;
files(n).FrameFlash=''
files(n).Moviefile='Prey1\7_28_15\Prey1_sub1_trial4_NIR_1st_90secs.avi'
...
files(n).sex=1;
files(n).FrameS=1;
files(n).FrameEnd=595;
files(n).FrameFlash=''
files(n).Moviefile='Prey1\9_2_15\9_2_15_prey1_Trial_1_FS.avi'
...
files(n).sex=1;
files(n).FrameS=1;
files(n).FrameEnd=1800;
files(n).FrameFlash=''
files(n).Moviefile='Prey1\9_2_15\9_2_15_prey1_Trial_2_NIR.avi';
...
files(n).headbar = 1;
files(n).contrast = 100;
files(n).notes = 'caught cricket after video ended';
files(n).fps=60;
files(n).scale=35;%pixels/cm on video tracking
files(n).group=1;
files(n).sex=1;
