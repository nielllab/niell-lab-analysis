...
% cd('F:\prey_capture_lkhd_analysis\figure\2024_12_16\')

% cd('F:\prey_capture_lkhd_analysis\figure\2025_01_06\')
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_spd_indiv_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_spd_avg_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_az_indiv_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_az_avg_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_distd_indiv_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_distd_avg_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_cspd_indiv_line.png'], 'png')
    close
end
...
for icond = 1:8
    ...
    F = getframe(f);
    imwrite(F.cdata, [cond_list{icond} '_cspd_avg_line.png'], 'png')
    close
end
