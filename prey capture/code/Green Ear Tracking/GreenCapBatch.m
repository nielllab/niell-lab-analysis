...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_PKYX.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_PSHD.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_RVLC.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_SITN.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_XUQZ.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
...
files(n).type=1;
files(n).lighting = ON;
files(n).Tfiles = 'GF\Tracks_XXJH.mat';
files(n).contrast = 100;
files(n).notes = '';
files(n).fps=30;
files(n).scale=22;%pixels/cm on video tracking
