...
% Last Modified by GUIDE v2.5 15-Aug-2007 17:04:21
...
raster_generic(Tank_Name, Block_Name,channel_list, nrows, ncols, bin_size,max_rate)
...
pname = uigetdir('C:\data','block data')   %%% start location of tanks for search
