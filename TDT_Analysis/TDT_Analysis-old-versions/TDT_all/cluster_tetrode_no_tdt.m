function cluster_tetrode_no_tdt
% Matlab codes for reading from TTank

clear all;
pack
close all
Tank_Name='041007_wt_tet'
nblocks = 6;
...
%    save spikedata 
    ...
    tic; dos('C:\KlustaKwik pca 1 -MinClusters 5 -MaxClusters 10 -MaxPossibleClusters 12 -Verbose 0 -nStarts 2'); toc
    %n_pca=4;
    cl_name = 'pca.clu.1';
