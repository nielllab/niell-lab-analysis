...
% Last Modified by GUIDE v2.5 25-Sep-2007 15:22:56
...
channel_list = str2num(get(handles.Channel_List,'String')); %#ok
bin_size = str2double(get(handles.bin_size,'String'));
max_rate = str2double(get(handles.max_rate,'String'));
nrows = str2double(get(handles.nrows,'String'));
ncols = str2double(get(handles.ncols,'String'));

isorientation = get(handles.checkbox_orientation,'Value');

generic_raster(Tank_Name, Block_Name,channel_list, nrows, ncols, bin_size, max_rate, isorientation)
...
% --- Executes on button press in checkbox_orientation.
function checkbox_orientation_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_orientation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_orientation
