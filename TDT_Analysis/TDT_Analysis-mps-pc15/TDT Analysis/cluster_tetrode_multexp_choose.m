%function cluster_tetrode_multexp_choose
...
Block_Name={'drift4' 'wn_contrast4' 'cp_tf4' 'flash_grat4' 'sb4' 'bars16d4b' }
Block_Name = {'drift1' 'wn_contrast1b' 'cp_tf1' 'flash_grat1' 'sb1b' 'bars16d1b'}
Block_Name = {'drift1'  'wn_contrast10sec' 'cp_tf1' 'cp_tflo' 'cp_tfhi' 'flash_grt_lo'  'flsh_grt_hi' 'sb1' 'bars16d1' 'bars16d2'};

Block_Name = {'drift1' 'wn1' 'sb1' 'cp_tflo' 'cp_tfhi016' 'flashgrat_lo' 'flashgrat_hi' 'bars16d1' 'bars16d1fast' 'bars16d2'}

Block_Name = {'drift1'  'wn1' 'sb1' 'cp_tflo' 'cp_tfhi' 'flash_gratlo' 'flashgrat_hi' 'bars16d1_9contrast' 'bars16d2'}
Block_Name = { 'drift1' 'wn1' 'sb1' 'cptf1' 'bars16d1b' 'bars16d1c' 'flashgrat1'}
Block_Name = {'drift1' 'wn1b' 'sb1' 'cptf1' 'flashgrat1' 'bars16d1' 'bars16d1b'}
Block_Name = { 'bars16d2' }
...
%                         end
   ...
   if threshold_voltage
    ...
    %      allXdata(:,i) = chandata(:);
    %  end
    %  [Xica m u] = fastica(allXdata'*10^6,'stabilization','on');
    %
    %  m
    %  u
    %
    ...
    %
    %   for i = 1:4
    %       X(:,:,i)= sign(sum(u(i,:)))*reshape(Xica(:,i),Xsize(2),Xsize(1))'/10^6;
    %   end
...
if choose_pca
    ...
    tic; dos('C:\KlustaKwik_amd pca 1 -MinClusters 5 -MaxClusters 10 -MaxPossibleClusters 12 -Verbose 0 -nStarts 2'); toc
    %n_pca=4;
    cl_name = 'pca.clu.1';
    idx = uint8(dlmread(cl_name));
    n_clust = idx(1)
    if sum(idx==1)==0    %%% if no members of outlier cluster
        n_clust=n_clust-1;
        idx = idx-1;
    end
