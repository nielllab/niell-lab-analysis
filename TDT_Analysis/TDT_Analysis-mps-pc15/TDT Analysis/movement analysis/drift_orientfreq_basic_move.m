function drift_orientfreq_basic_move
...
mouseUDP_version = 1; %%% there are two versions of mouse sender software : original for TDT (0), and revised for contimage to pack XY into one byte (1)
n_reps = 2;
...
if n_reps>1
     [tsamp vsmooth] = getBlockVelocity_general(Tank_Name,Block_Name,mouseUDP_version);
    thresh_velocity = 1;
end
