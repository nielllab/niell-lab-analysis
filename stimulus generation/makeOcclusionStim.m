...
cond = cond(order); occContrast = occContrast(order); 
end
...
% drawnow
% end
save occludeStim8cond_24min moviedata  tf sf phase theta framerate duration isi cond occContrast -v7.3
size(moviedata)
length(moviedata)/(60)
figure
for rep = 1:12;
...
figure
for fr = 1:5:(12*duration*framerate)
